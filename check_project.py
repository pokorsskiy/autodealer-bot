...
def check_python_syntax():
    ...
    for root, _, files in os.walk("."):
        if ".venv" in root or ".git" in root or "showcase_bot" in root:
            continue
        for file in files:
            if file.endswith(".py"):
...
if __name__ == "__main__":
    ...
    print("==================================================")
    print("🚀 ЗАПУСК ДИАГНОСТИКИ ОСНОВНОГО БОТА (DEALER AUTO)")
    print("==================================================")
    ...
    if syntax_ok and env_ok and tg_ok and db_ok:
        print("🎉 ВСЕ ПРОВЕРКИ ПРОЙДЕНЫ! Основной бот готов к запуску.")
    else:
